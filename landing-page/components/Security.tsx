  ...
  const securityFeatures = [
    {
      ...
      description: "Only you control access to your vault and content.",
      badge: "PRIVACY",
    },
    {
      icon: Database,
      title: "On‑chain Integrity",
      description: "Tamper‑evident records backed by Polygon.",
      badge: "INTEGRITY",
    },
    {
      icon: Lock,
      title: "End‑to‑end Safety",
      description: "Local encryption before anything leaves your device.",
      badge: "SAFE",
    },
    {
      icon: Key,
      title: "Self‑Custody Keys",
      description: "You hold the keys — not custodial, not shared.",
      badge: "SOVEREIGN",
    },
    {
      icon: Eye,
      title: "Transparent Actions",
      description: "Every action is visible and auditable by you.",
      badge: "CLEAR",
    },
    {
      icon: CheckCircle,
      title: "Resilient Storage",
      description: "Designed for durability and availability.",
      badge: "RESILIENT",
    },
  ];
